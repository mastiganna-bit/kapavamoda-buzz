      ...
      <div className="mt-6 rounded-3xl border border-slate-200 bg-white shadow-sm p-6">
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          <div>
            ...
            <input value={id} onChange={e=>setId(e.target.value)} placeholder="kapavamoda1234@gmail.com" className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-3.5 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50" />
          </div>
          <div>
